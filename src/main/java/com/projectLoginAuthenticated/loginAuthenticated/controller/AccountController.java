package com.projectLoginAuthenticated.loginAuthenticated.controller;
...
import com.projectLoginAuthenticated.loginAuthenticated.model.RegisterDto;
...
public class AccountController {
	...
	public String register(Model model, @Valid @ModelAttribute RegisterDto registerDto, BindingResult result) {
		...
		if (!registerDto.getPassword().equals(registerDto.getConfirmPassword())) {
			new FieldError("registerDto", "confirmPassword", "Password and Confirm password od not match");
		}
